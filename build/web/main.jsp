                    ...
                    <div class="container">
                        <div class="row">
                            <ul class="thumbnails thumbnails-1">
                                ...
                                <li class="span3">
                                    <div class="thumbnail thumbnail-1">
                                        <h3 class="title-1 extra">Sha Tin</h3>
                ...
                <div class="container">
                    <div class="row">
                        <article class="span5">
                            ...
                            <div class="wrapper">
                                <figure class="img-indent span4"><img src="img/page1-img5.jpg " alt="" /></figure>
                                <div class="inner-1 overflow extra">
                                    <div class="txt-1">Fury (2014)</div>
...
<!--                                    <div class="overflow">
                        ...
                        <article class="span7">
                            <h3>Latest Movies</h3>
                            <ul class="list-photo">
                                <li class="span2"><a href="img/page1-img6.jpg" class="magnifier" ><img src="img/page1-img6.jpg " alt="" /></a></li>
                                <li class="span2"><a href="img/page1-img7.jpg" class="magnifier" ><img src="img/page1-img7.jpg " alt="" /></a></li>
                                <li class="span2"><a href="img/page1-img8.jpg" class="magnifier" ><img src="img/page1-img8.jpg " alt="" /></a></li>
                                <li class="span2"><a href="img/page1-img9.jpg" class="magnifier" ><img src="img/page1-img9.jpg " alt="" /></a></li>
                                <li class="span2"><a href="img/page1-img10.jpg" class="magnifier" ><img src="img/page1-img10.jpg " alt="" /></a></li>
                                <li class="span2"><a href="img/page1-img11.jpg" class="magnifier" ><img src="img/page1-img11.jpg " alt="" /></a></li>
                            </ul>
                        </article>
                    </div>
                </div>
