    ...
    <body ng-app="login">
        <div class="wrapper">
            ...
            <form id="login-form" class="login" method='get' novalidate=''>
                <p class="login__title">sign in <br><span class="login-edition">welcome to CP.Movie</span></p>
            ...
            <section class="container">
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="footer-info">
                        <p class="heading-special--small">CP.Movie<br><span class="title-edition">in the social media</span></p>
